...
- [x] [[a54e00b1-2467-468e-bdc9-5de3b2fcb3f1|插入过程（mapassign）]]：
    - 插入新 key 时，如果当前 bucket 已经满了（8 个槽位都占用了），会发生什么？
- [x] [[e14018a1-cd6f-4e89-bfdf-eb628f3314c6|删除过程（mapdelete）]]：
    - 删除元素后，map 占用的内存会归还给操作系统吗？
    - `emptyOne` 和 `emptyRest` 状态有什么区别？状态向前传播是为了解决什么问题？
- [x] [[54c7d285-4878-4c1e-99eb-57d2f814da07|扩容机制（hashGrow 与 evacuate）]]：
